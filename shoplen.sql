...
-- ----------------------------------------
-- 6. BẢNG: DON_HANG, CHI_TIET_DON_HANG & LICH_SU (Mở rộng lên 16 đơn hàng mẫu)
-- ----------------------------------------
...
('DH000003', 4, 'completed', 43000.00, NULL, 0.00, 'key-003', 1, '456 Đường Nguyễn Trãi', 'Nguyễn Văn Huy', '0909876543', 18000.00, 'GH_TIETKIEM'),
('DH000004', 5, 'pending', 272000.00, NULL, 0.00, 'key-004', 2, '789 Đường Lê Lợi', 'Nguyễn Văn Long', '0912345678', 32000.00, 'GH_NHANH'),
('DH000005', 6, 'processing', 128000.00, 1, 15000.00, 'key-005', 6, '12 Lý Thường Kiệt', 'Lê Thị Mai', '0923456789', 18000.00, 'GH_TIETKIEM'),
('DH000006', 7, 'shipping', 122000.00, NULL, 0.00, 'key-006', 11, '45 Trần Phú', 'Phạm Minh Đức', '0934567890', 32000.00, 'GH_NHANH'),
('DH000007', 8, 'completed', 153000.00, 2, 20000.00, 'key-007', 16, '88 Điện Biên Phủ', 'Hoàng Thị Dung', '0945678901', 18000.00, 'GH_TIETKIEM'),
('DH000008', 4, 'cancelled', 77000.00, NULL, 0.00, 'key-008', 3, '123 Đinh Tiên Hoàng', 'Nguyễn Văn Huy', '0909876543', 32000.00, 'GH_NHANH'),
('DH000009', 9, 'pending', 188000.00, NULL, 0.00, 'key-009', 21, '34 Nguyễn Trãi', 'Đào Linh Chi', '0956789012', 18000.00, 'GH_TIETKIEM'),
('DH000010', 10, 'completed', 412000.00, 5, 15000.00, 'key-010', 4, '99 Cách Mạng Tháng 8', 'Vũ Anh Tuấn', '0967890123', 32000.00, 'GH_NHANH'),
('DH000011', 11, 'processing', 113000.00, NULL, 0.00, 'key-011', 8, '14 Hàng Bạc', 'Bùi Thị Ngọc', '0978901234', 18000.00, 'GH_TIETKIEM'),
('DH000012', 12, 'shipping', 382000.00, NULL, 0.00, 'key-012', 12, '55 Hùng Vương', 'Đỗ Hoàng Việt', '0989012345', 32000.00, 'GH_NHANH'),
('DH000013', 5, 'completed', 198000.00, NULL, 0.00, 'key-013', 2, '789 Đường Lê Lợi', 'Nguyễn Văn Long', '0912345678', 18000.00, 'GH_TIETKIEM'),
('DH000014', 4, 'processing', 168000.00, NULL, 0.00, 'key-014', 1, '123 Đồng Khởi', 'Nguyễn Văn A', '0911111111', 18000.00, 'GH_TIETKIEM'),
('DH000015', 5, 'processing', 352000.00, NULL, 0.00, 'key-015', 2, '456 Lê Lợi', 'Trần Thị B', '0922222222', 32000.00, 'GH_NHANH'),
('DH000016', 6, 'processing', 228000.00, NULL, 0.00, 'key-016', 6, '789 Tràng Tiền', 'Lê Văn C', '0933333333', 18000.00, 'GH_TIETKIEM'),
('DH000017', 11, 'completed', 213000.00, 11, 15000.00, 'key-017', 8, '32 Gia Ngư', 'Bùi Thị Ngọc', '0978901234', 32000.00, 'GH_NHANH'),
('DH000018', 15, 'pending', 110000.00, 12, 32000.00, 'key-018', 3, '55bis Nguyễn Thị Minh Khai', 'Tống Khánh Linh', '0912112233', 32000.00, 'GH_NHANH');
...
('DH000017', 11, 'Thú Bông Khủng Long Xanh', 195000.00, 1),
('DH000018', 12, 'Sợi Dệt Macrame Cotton', 110000.00, 1);
...
('DH000004', 'pending'), ('DH000005', 'pending'), ('DH000005', 'processing'),
...
('DH000008', 'pending'), ('DH000008', 'cancelled'), ('DH000014', 'pending'), ('DH000014', 'processing'),
('DH000017', 'pending'), ('DH000017', 'completed'), ('DH000018', 'pending');

-- ----------------------------------------
-- 7. BẢNG: THANH_TOAN & HOAN_TIEN (16 records thanh toan đầy đủ)
-- ----------------------------------------
INSERT INTO thanh_toan (don_hang_id, phuong_thuc, trang_thai, ma_tham_chieu) VALUES 
('DH000003', 'COD', 'paid', 'COD-003'), ('DH000004', 'COD', 'pending', NULL), ('DH000005', 'COD', 'pending', NULL),
('DH000006', 'COD', 'pending', NULL), ('DH000007', 'COD', 'paid', 'COD-007'), ('DH000008', 'COD', 'failed', NULL),
('DH000009', 'COD', 'pending', NULL), ('DH000010', 'COD', 'paid', 'COD-010'), ('DH000011', 'COD', 'pending', NULL),
('DH000012', 'COD', 'pending', NULL), ('DH000013', 'COD', 'paid', 'COD-013'), ('DH000014', 'COD', 'pending', NULL),
('DH000015', 'COD', 'pending', NULL), ('DH000016', 'COD', 'pending', NULL), ('DH000017', 'MOMO', 'paid', 'MOMO-PAY77'),
('DH000018', 'MOMO', 'pending', NULL);

-- Hoàn tiền mở rộng lên 15 dòng mẫu chuẩn
...
('DH000014', 25000.00, 'Khách giảm số lượng cuộn len khi đóng hàng', 'success'),
('DH000015', 32000.00, 'Hoàn lại tiền chênh lệch chương trình Flash Sale', 'pending'),
('DH000016', 52500.00, 'Hoàn trả tiền 1 cuộn nhung đũa bị lỗi sợi', 'success'),
('DH000007', 5000.00, 'Đền bù voucher lỗi hệ thống', 'success'),
('DH000013', 15000.00, 'Sản phẩm giao thiếu phụ kiện mác nút gỗ', 'pending');
